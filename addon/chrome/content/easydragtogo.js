        ...
        switch (act) {
            ...
            case "link-bg":
                ...
                if (cur)
                    ...
                    //alert('uri:'+uri)
                    gBrowser.loadOneTab(uri, { relatedToCurrent: aRelatedToCurrent, userContextId: gBrowser.contentPrincipal.originAttributes.userContextId, triggeringPrincipal: Services.scriptSecurityManager.createNullPrincipal({}), postData: postData.value, inBackground: bg, allowThirdPartyFixup: false });
                }
                break;
            ...
            case "img-bg":
                ...
                gBrowser.loadOneTab(src, { userContextId: gBrowser.contentPrincipal.originAttributes.userContextId, triggeringPrincipal: Services.scriptSecurityManager.createNullPrincipal({}), inBackground: inBackground, allowThirdPartyFixup: false });
                break;
